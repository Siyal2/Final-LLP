              ...
              <div className="footer1-form">
                ...
                <button className="thq-button-outline footer1-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer1-text14">/cookies-policy</span>
                      </Fragment>
                    )}
                  </span>
                </button>
                ...
                {props.content2 ?? (
                  <Fragment>
                    <span className="footer1-text18">
                      © 2023 Raje Shivchatrapati Multipurpose Charitable
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong className="thq-body-large footer1-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer1-text24">Quick Links</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links1">
                ...
                >
                  {props.link2 ?? (
                    <Fragment>
                      <span className="footer1-text27">About Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer1-text26">Programs</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer1-text16">Events</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer1-text12">Get Involved</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column2">
              ...
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer1-text20">Donate</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer1-text11">Volunteer</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer1-text13">Contact Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer1-text19">Facebook</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text23">Instagram</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column3">
              <strong className="thq-body-large footer1-social-link1-title">
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <span className="footer1-text28">Follow Us</span>
                  </Fragment>
                )}
              </strong>
          ...
          <div className="footer1-row">
            ...
            <div className="footer1-footer-links3">
              ...
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer1-text17">Cookies Policy</span>
                  </Fragment>
                )}
              </span>
            </div>
